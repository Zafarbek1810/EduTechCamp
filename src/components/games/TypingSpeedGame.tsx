      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold">Typing Speed Game</h3>
          </div>
          ...
          <CardContent>
            <div className="text-center space-y-4">
              <p className="text-muted-foreground">
                You ran out of time! Try again to improve your typing speed.
              </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2 text-sm">
              <p>• Type the word shown on screen and press space to continue</p>
              <p>• You have 5 minutes to type as many words as possible</p>
              <p>• Your WPM (Words Per Minute) and accuracy are tracked</p>
              <p>• Choose difficulty level: Easy, Medium, or Hard</p>
              <p>• Score is calculated based on WPM × Accuracy</p>
            </div>
          </CardContent>
        </Card>
      )}
